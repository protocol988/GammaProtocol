...
library forwards {
    ...
    function _mintForward(
        Actions.depositForwardArgs memory _args,
        WhitelistInterface whitelist,
        MarginVault.Vault storage vault,
        uint256 vaultType,
        MarginPoolInterface pool,
        MarginPoolInterface borrowablePool,
        uint256 vaultCount
    ) external {
     ...
     */
    function _burnForward(
        Actions.BurnForwardArgs memory _args,
        WhitelistInterface whitelist,
        MarginVault.Vault storage vault,
        uint256 vaultType,
        MarginPoolInterface pool,
